    ...
    var e = {
      754: (e, t, n) =>{
        ...
        class s extends r {
          constructor() {
            ...
            (e = '_storage') in this ? Object.defineProperty(this, e, {
              value: t,
              enumerable: !0,
              configurable: !0,
              writable: !0
        ...
        function g(e) {
          ...
          !i || !n.pathname.endsWith('/') && n.pathname.endsWith(`/${ i }`) || (r.endsWith('/') || (r += '/'), r += i),
          n.pathname = r;
          const {
            jwt: s,
            lang: o,
            ...
            this._transport.on('event', (e=>{
              ...
              switch (t) {
                case 'video-conference-joined':
                  void 0 !== this._tmpE2EEKey && (this.executeCommand(C.e2eeKey, this._tmpE2EEKey), this._tmpE2EEKey = void 0),
                  this._myUserID = r,
                ...
                case 'local-storage-changed':
                  return o.setItem('jitsiLocalStorage', n.localStorageContent),
                  !0
              }
              const i = E[t];
      ...
      369: (e, t, n) =>{
        ...
        function i(e, t) {
          ...
          this.storeInterval = t && t.storeInterval ? t.storeInterval : 30000,
          this.maxEntryLength = t && t.maxEntryLength ? t.maxEntryLength : 10000,
        ...
        i.prototype._flush = function (e, t) {
          ...
          }.bind(this)), this.outputCache = [
          ]), this.logStorage.storeLogs(this.queue)) : this.outputCache.push(this.queue), this.queue = [
          ], this.totalLen = 0),
      ...
      7: e=>{
        ...
        function i() {
          ...
          !r || r.length <= 4 ? (0 === n[2].indexOf('log@') ? e.methodName = n[3].substr(0, n[3].indexOf('@')) : e.methodName = n[2].substr(0, n[2].indexOf('@')), e) : (e.methodName = r[1], e.fileLocation = r[2], e.line = r[3], e.column = r[4], e)
        }
        function s() {
          var e = arguments[0],
          s = arguments[1],
      ...
      860: (e, t, n) =>{
        ...
        e.exports = {
          ...
          setLogLevelById: function (e, t) {
            for (var n = t ? s[t] || [
            ] : o, r = 0; r < n.length; r++) n[r].setLevel(e)
          },
      ...
      620: e=>{
        ...
        function l(e, t, n, r) {
          ...
          o,
          l;
          if (a(n), void 0 === (s = e._events) ? (s = e._events = Object.create(null), e._eventsCount = 0) : (void 0 !== s.newListener && (e.emit('newListener', t, n.listener ? n.listener : n), s = e._events), o = s[t]), void 0 === o) o = s[t] = n,
          ++e._eventsCount;
            ...
            o,
            n
          ] : r ? o.unshift(n) : o.push(n), (i = c(e)) > 0 && o.length > i && !o.warned) {
            o.warned = !0;
