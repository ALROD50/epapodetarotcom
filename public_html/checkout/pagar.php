                ...
                <div class="card tab-content p-3 mb-4 shadow mt-2" id="myTabContent" style="border:none; margin-top: -0.5rem !important;">
                    ...
                    <div class="tab-pane fade show d-none" id="tabCreditoGE" role="tabpanel" aria-labelledby="tabCreditoGE-tab">
                        ...
                        <div class="form-group">
                            ...
                            <label id="creditCardBrandtabGEL">Selecione a Bandeira:</label>
                            
                            <label id="bandeirasselect" class="checkbox-inline" onclick="OpPagCardGE()">
                                <input type="radio" name="creditCardBrandtabGE" id="creditCardBrandtabGE1" value="visa"><img src="checkout/img/visa_cartao.jpg" border="0" align="absmiddle">
                            </label>
                            <label class="checkbox-inline" onclick="OpPagCardGE()">
                                <input type="radio" name="creditCardBrandtabGE" id="creditCardBrandtabGE2" value="mastercard"><img src="checkout/img/master_cartao.jpg" border="0" align="absmiddle">
                            </label>
                            <label class="checkbox-inline" onclick="OpPagCardGE()">
                                <input type="radio" name="creditCardBrandtabGE" id="creditCardBrandtabGE3" value="elo"><img src="checkout/img/elo_cartao.jpg" border="0" align="absmiddle"> 
                            </label>
                            <label class="checkbox-inline" onclick="OpPagCardGE()">
                                <input type="radio" name="creditCardBrandtabGE" id="creditCardBrandtabGE4" value="diners" ><img src="checkout/img/diners_cartao.jpg" border="0" align="absmiddle">
                            </label>
                            <label class="checkbox-inline" onclick="OpPagCardGE()">
                                <input type="radio" name="creditCardBrandtabGE" id="creditCardBrandtabGE5" value="amex" ><img src="checkout/img/amex_cartao.jpg" border="0" align="absmiddle">
                            </label>
                            <label class="checkbox-inline" onclick="OpPagCardGE()">
                                <input type="radio" name="creditCardBrandtabGE" id="creditCardBrandtabGE6" value="hipercard" ><img src="checkout/img/hipercard_cartao.jpg" border="0" align="absmiddle">
                            </label>
                            <div id="ErrocreditCardBrandtabGE" style="display: none; clear: both;">
                                <img src="checkout/img/error-icon.png" alt=""> Por favor, seleciona uma bandeira.
                            </div>
                        </div>

                        <!-- dados do cartão de crédito -->
                        <div id="OpPagCardGE" style="display:none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label id="cardNumberLGE">Número do cartão</label>
                                        <div class="col-md-12" style="padding-left: 0px; padding-right: 0px;">
                                            <div class="input-group">
                                                <input type="tel" name="cardNumberGE" id="cardNumberGE" placeholder="0000 0000 0000 0000" required value="" class="form-control input-lg cardNumber" autocomplete="off" onkeyup="LimpaBordaVermelha(this.id);"/>
                                                <div class="input-group-prepend"><i class="fas fa-credit-card input-group-text"></i></div>
                                            </div>
                                        </div>
                                        <div id="ErrocardNumberGE" style="display: none; clear: both;">
                                            <img src="checkout/img/error-icon.png" alt=""> Por favor, informe o número completo do seu cartão de crédito.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                        ...
                                        <label id="cardExpiryMLGE">Data de validade</label>
                                        <div class="form-row">

                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <div class="input-group">
                                                    <input type="tel" name="cardExpiryMGE" id="cardExpiryMGE" placeholder="Mês" required value="" class="form-control input-lg cardExpiryM" onkeyup="LimpaBordaVermelha(this.id);"/>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <div class="input-group">
                                                    <input type="tel" name="cardExpiryYGE" id="cardExpiryYGE" placeholder="Ano" required value="" class="form-control input-lg cardExpiryY" onkeyup="LimpaBordaVermelha(this.id);" />
                                                    <div class="input-group-prepend"><i class="fas fa-calendar-alt input-group-text"></i></div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="ErrocardExpiryMGE" style="display: none; clear: both;">
                                            <img src="checkout/img/error-icon.png" alt=""> O mês de validade deve ter 2 digitos.
                                        </div>
                                        <div id="ErrocardExpiryYGE" style="display: none; clear: both;">
                                            <img src="checkout/img/error-icon.png" alt=""> Informe o ano de validade corretamente.
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label id="creditCardHolderNameLGE">Nome do dono do cartão</label>
                                        <div class="col-md-12" style="padding-left: 0px; padding-right: 0px;">
                                            <div class="input-group">
                                                <input type="text" name="creditCardHolderNameGE" id="creditCardHolderNameGE" placeholder="Nome Como Aparece no Cartão" required value="" class="form-control input-lg" onkeyup="LimpaBordaVermelha(this.id);" />
                                                <div class="input-group-prepend"><div class="input-group-text"><i class="fas fa-user"></i></div></div>
                                            </div>
                                            <p><small>Ex.: CARLOS A F DE OLIVEIRA</small></p>
                                        </div>
                                        <div id="ErrocreditCardHolderNameGE" style="display: none; clear: both;">
                                            <img src="checkout/img/error-icon.png" alt=""> Informe o nome e sobrenome do dono como aparece no cartão.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label id="cardCVCLGE">Código de segurança <small><a class="btn btn-primary btn-xs" title="Localizando Código de Segurança" role="button" data-toggle="collapse" href="#collapseCodSeguGE" aria-expanded="false" aria-controls="collapseCodSeguGE">?</a></small></label>
                                        <div class="col-md-5 col-xs-12" style="padding-left: 0px; padding-right: 0px;">
                                            <div class="input-group">
                                                <input type="tel" name="cardCVCGE" id="cardCVCGE" placeholder="000" value="" maxlength="5"  class="form-control input-lg cardCVC" onkeyup="LimpaBordaVermelha(this.id);"/>
                                                <div class="input-group-prepend"><div class="input-group-text">*</div></div>
                                            </div>
                                        </div>
                                    </div>
                                    <p><small>Geralmente localizado no verso do cartão.</small></p>
                                    <div id="ErrocardCVCGE" style="display: none; clear: both;">
                                        <img src="checkout/img/error-icon.png" alt=""> Informe o código de segurança do seu cartão corretamente.
                                    </div>
                                    <div class="collapse panel panel-success" id="collapseCodSeguGE">
                                        <div class="panel-heading">
                                            <h2>Código de segurança</h2>
                                        </div>
                                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label id="creditCardHolderCPFLGE">CPF do dono do cartão</label>
                                        <div class="col-md-12" style="padding-left: 0px; padding-right: 0px;">
                                            <div class="input-group">
                                                <input type="tel" name="creditCardHolderCPFGE" id="creditCardHolderCPFGE" required value="<?php echo $cpf; ?>" class="form-control input-lg cpf" onkeyup="LimpaBordaVermelha(this.id);"/>
                                                <div class="input-group-prepend"><i class="fas fa-address-card input-group-text"></i></div>
                                            </div>
                                        </div>
                                        <div id="ErrocreditCardHolderCPF" style="display: none; clear: both;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label id="creditCardHolderPhoneLGE">Celular do dono do cartão</label>
                                        <div class="row" style="padding-left: 0px; padding-right: 0px;">
                                            <div class="col-md-3 col-xs-4" style="padding-left: 0px; padding-right: 10px;">
                                                <div class="input-group">
                                                    <input type="tel" name="creditCardHolderAreaCodeGE" id="creditCardHolderAreaCodeGE" placeholder="DDD" required value="<?php echo $ddd; ?>" class="form-control input-lg area" onkeyup="LimpaBordaVermelha(this.id);" />
                                                </div>
                                            </div>

                                            <div class="col-md-9" style="padding-left: 0px; padding-right: 0px; padding-bottom: 15px;">
                                                <div class="input-group">
                                                    <input type="tel" name="creditCardHolderPhoneGE" id="creditCardHolderPhoneGE" required value="<?php echo $numerocel; ?>" class="form-control input-lg phone" onkeyup="LimpaBordaVermelha(this.id);" />
                                                    <div class="input-group-prepend"><div class="input-group-text"><i class="fas fa-phone"></i></div></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div id="ErrocreditCardHolderAreaCodeGE" style="display: none; clear: both;">
                                            <img src="checkout/img/error-icon.png" alt=""> Informe o código de área válido.
                                        </div>
                                        <div id="ErrocreditCardHolderPhoneGE" style="display: none; clear: both;">
                                            <img src="checkout/img/error-icon.png" alt=""> Informe uma número de celular válido.
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label id="creditCardHolderBirthDateLGE">Data Nascimento</label>
                                        <div class="col-md-10" style="padding-left: 0px; padding-right: 0px;">
                                            <div class="input-group">
                                                <input type="tel" name="creditCardHolderBirthDateGE" id="creditCardHolderBirthDateGE" placeholder="Dia/Mês/Ano" required value="<?php echo $datanascimento; ?>" class="form-control input-lg data-mask" onkeyup="LimpaBordaVermelha(this.id);" />
                                                <div class="input-group-prepend"><div class="input-group-text">*</div></div>
                                            </div>
                                            <p><small>Ex.: 20/05/1980</small></p>
                                        </div>
                                        <div id="ErrocreditCardHolderBirthDateGE" style="display: none; clear: both;">
                                            <img src="checkout/img/error-icon.png" alt=""> Por favor, confira se a data de nascimento informada está correta. Exemplo: 20/05/1990.
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label onclick="OpenEndCardGE()">
                                                <input type="radio" name="UsarMesmoEndCardGE" value="sim" onclick="OpenEndCardGE()" checked> O mesmo informado acima
                                            </label>
                                            <div id="EndCardUmGE" style="margin-top: 10px; display: block; font-size:15px;">
                                                <input type="text" name="billingAddressStreetGE" id="billingAddressStreetGE" value="<?php echo $endereco ?>" disabled style="border: none; background: none; color:#000; padding: 0px 0px 0px 5px; min-height: 10px; width:100%;"/>
                                                <input type="text" name="billingAddressNumberGE" id="billingAddressNumberGE" value="<?php echo $numero ?>" disabled style="border: none; background: none; color:#000; padding: 0px 0px 0px 5px;min-height: 10px;"/>
                                                <input type="text" name="billingAddressComplementGE" id="billingAddressComplementGE" value="<?php echo $complemento ?>" disabled style="border: none; background: none; color:#000; padding: 0px 0px 0px 5px;min-height: 10px;"/>
                                                <input type="text" name="billingAddressDistrictGE" id="billingAddressDistrictGE" value="<?php echo $bairro ?>" disabled style="border: none; background: none; color:#000; padding: 0px 0px 0px 5px; min-height: 10px;"/>
                                                <input type="text" name="billingAddressPostalCodeGE" id="billingAddressPostalCodeGE" value="<?php echo $cep ?>" disabled style="border: none; background: none; color:#000; padding: 0px 0px 0px 5px; min-height: 10px;"/>
                                                <input type="text" name="billingAddressCityGE" id="billingAddressCityGE" value="<?php echo $cidade ?>" disabled style="border: none; background: none; color:#000; padding: 0px 0px 0px 5px; min-height: 10px;"/>
                                                <input type="text" name="billingAddressStateGE" id="billingAddressStateGE" value="<?php echo $estado ?>" disabled style="border: none; background: none; color:#000; padding: 0px 0px 0px 5px; min-height: 10px;"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label onclick="CloseEndCardGE()">
                                                <input type="radio" name="UsarMesmoEndCardGE" value="nao" onclick="CloseEndCardGE()"> Outro endereço
                                            </label>
                                            <div id="EndCardDoisGE" style="margin-top: 10px; display: none;">
                                                <label for="">CEP</label>
                                                <input type="tel" name="billingAddressPostalCodeGE" id="billingAddressPostalCodexGE" class="form-control input-lg cep" onkeyup="pesquisacepDoisGE(this.value); LimpaBordaVermelha(this.id);"/>
                                                <div id="EbillingAddressPostalCodeGE" style="display: none; clear: both;">
                                                    <img src="checkout/img/error-icon.png" alt=""> Informe o CEP corretamente.
                                                </div>
                                                <div id="NaoEncontradoGE" style="display: none; clear: both;">
                                                    <img src="checkout/img/error-icon.png" alt=""> Endereço não encontrado...
                                                </div>
                                                <div id="EndDoisGE" style="display: none;">
                                                    <label for="">Rua</label>
                                                    <input type="text" name="billingAddressStreetGE" id="billingAddressStreetxGE" value="" class="form-control input-lg" onkeyup="LimpaBordaVermelha(this.id);" />
                                                    <div id="EbillingAddressStreetGE" style="display: none; clear: both;">
                                                        <img src="checkout/img/error-icon.png" alt=""> Informe a Rua corretamente.
                                                    </div>
                                                    <label for="">Número</label>
                                                    <input type="text" name="billingAddressNumberGE" id="billingAddressNumberxGE" value="" class="form-control input-lg" onkeyup="LimpaBordaVermelha(this.id);" />
                                                    <div id="EbillingAddressNumberGE" style="display: none; clear: both;">
                                                        <img src="checkout/img/error-icon.png" alt=""> Informe o Número corretamente.
                                                    </div>
                                                    <label for="">Complemento</label>
                                                    <input type="text" name="billingAddressComplementGE" id="billingAddressComplementxGE" value="" class="form-control input-lg"/>
                                                    <label for="">Bairro</label>
                                                    <input type="text" name="billingAddressDistrictGE" id="billingAddressDistrictxGE" value="" class="form-control input-lg" onkeyup="LimpaBordaVermelha(this.id);"/>
                                                    <div id="EbillingAddressDistrictGE" style="display: none; clear: both;">
                                                        <img src="checkout/img/error-icon.png" alt=""> Informe o Bairro corretamente.
                                                    </div>
                                                    <label for="">Cidade</label>
                                                    <input type="text" name="billingAddressCityGE" id="billingAddressCityxGE" value="" class="form-control input-lg" onkeyup="LimpaBordaVermelha(this.id);"/>
                                                    <div id="EbillingAddressCityGE" style="display: none; clear: both;">
                                                        <img src="checkout/img/error-icon.png" alt=""> Informe a Cidade corretamente.
                                                    </div>
                                                    <label for="">Estado</label>
                                                    <select name="billingAddressStateGE" id="billingAddressStatexGE" class="form-control input-lg" onchange="LimpaBordaVermelha(this.id);">
                                                        <option value=""></option> 
                                                        <option value="AC">Acre</option>
                                                        <option value="AL">Alagoas</option> 
                                                        <option value="AM">Amazonas</option> 
                                                    ...
                                                    <div id="EbillingAddressStateGE" style="display: none; clear: both;">
                                                        <img src="checkout/img/error-icon.png" alt=""> Informe o Estado corretamente.
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="row">
                                        <label class="checkbox-horizontal" onclick="CloseDadosPessoaisDoisGE()">
                                            <input type="radio" name="DadosPessoaisDoisChekGE" value="sim" onclick="CloseDadosPessoaisDoisGE()" checked> Usar os mesmos dados informados para o cartão
                                        </label>
                                    </div>
                                    <div class="row">
                                        <label class="checkbox-horizontal" onclick="OpenDadosPessoaisDoisGE()">
                                            <input type="radio" name="DadosPessoaisDoisChekGE" value="nao" onclick="OpenDadosPessoaisDoisGE()"> Informar outros dados
                                        </label>
                                    </div>
                                 </div>
                                <div id="DadosPessoaisDoisGE" style="display: none;">
                                    <!-- Nome e cpf -->
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12" style="padding-left: 0px; padding-right: 0px;">
                                                    <div class="input-group">
                                                        <input type="text" name="senderNamexxGE" id="senderNamexxGE" required value="" class="form-control input-lg" onkeyup="LimpaBordaVermelha(this.id);" />
                                                        <div class="input-group-prepend"><div class="input-group-text"><i class="fas fa-user"></i></div></div>
                                                    </div>
                                                </div>
                                                <div id="EsenderNamexxGE" style="display: none; clear: both;">
                                                    <img src="checkout/img/error-icon.png" alt=""> Informe o Nome e Sobrenome Completo corretamente.
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12" style="padding-left: 0px; padding-right: 0px;">
                                                    <div class="input-group">
                                                        <input type="tel" name="senderCPFxxGE" id="senderCPFxxGE" required value="" class="form-control input-lg cpf" onkeyup="LimpaBordaVermelha(this.id);" />
                                                        <div class="input-group-prepend"><i class="fas fa-address-card input-group-text"></i></div>
                                                    </div>
                                                </div>
                                                <div id="EsenderCPFxxGE" style="display: none; clear: both;">
                                                    <img src="checkout/img/error-icon.png" alt=""> Por favor, insira um CPF válido.
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="row" style="padding-left: 0px; padding-right: 0px;">
                                                <div class="col-md-3 col-xs-4" style="padding-left: 0px; padding-right: 10px;">
                                                    <div class="input-group">
                                                        <input type="tel" name="senderAreaCodexxGE" id="senderAreaCodexxGE" placeholder="DDD" required value="" class="form-control input-lg area" onkeyup="LimpaBordaVermelha(this.id);" />
                                                    </div>
                                                </div>  
                                                <div class="col-md-9" style="padding-left: 0px; padding-right: 0px;">
                                                    <div class="input-group">
                                                        <input type="tel" name="senderPhonexxGE" id="senderPhonexxGE" required value="" class="form-control input-lg phone" onkeyup="LimpaBordaVermelha(this.id);" />
                                                        <div class="input-group-prepend"><div class="input-group-text"><i class="fas fa-phone"></i></div></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="EsenderAreaCodexxGE" style="display: none; clear: both;">
                                                <img src="checkout/img/error-icon.png" alt=""> Informe um DDD válido.
                                            </div>
                                            <div id="EsenderPhonexxGE" style="display: none; clear: both;">
                                                <img src="checkout/img/error-icon.png" alt=""> Informe um número de celular válido.
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8" style="padding: 0px;">
                                    <center>
                                        <br>
                                        <button id="enviarCartaoGE" name="enviarCartaoGE" class="btn btn-success btn-lg btn-block" type="button" data-loading-text="Aguarde..."><i class="fas fa-check-double"></i> PAGAR</button>
                                        <p><small>Confirmar Pagamento</small></p>
                                        <div id="carregandoGE" class="text-center mt-3" style="display:none;">
                                          <div class="spinner-border" role="status" aria-hidden="true"></div>
                                          Carregando...
                                        </div>
                                    </center>
                    ...
                    <!-- Débito -->
                    <div class="tab-pane fade show d-none" id="tabDebito" role="tabpanel" aria-labelledby="tabDebito-tab">

                        <h2 class="mb-4">Pagamento com Cartão de Débito:</h2>

                        <p>Por gentileza complete os dados abaixo para pagar com débito bancário online:</p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12" style="padding-left: 0px; padding-right: 0px;">
                                        <div class="input-group">
                                            <input type="text" name="senderNameD" id="senderNameD" required  value="<?php echo $nome; ?>" class="form-control" onkeyup="LimpaBordaVermelha(this.id);" />
                                            <div class="input-group-prepend"><div class="input-group-text"><i class="fas fa-user"></i></div></div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12" style="padding-left: 0px; padding-right: 0px;">
                                        <div class="input-group">
                                            <input type="tel" name="senderCPFD" id="senderCPFD" required  value="<?php echo $cpf; ?>" class="form-control cpf" onkeyup="LimpaBordaVermelha(this.id);" />
                                            <div class="input-group-prepend"><i class="fas fa-address-card input-group-text"></i></div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row" style="padding-left: 0px; padding-right: 0px;">
                                    <div class="col-md-3 col-xs-4" style="padding-left: 0px; padding-right: 10px;">
                                        <div class="input-group">
                                            <input type="tel" name="senderAreaCodeD" id="senderAreaCodeD" placeholder="DDD" required  value="<?php echo $ddd; ?>" class="form-control area" onkeyup="LimpaBordaVermelha(this.id);" />
                                        </div>
                                    </div>  
                                    <div class="col-md-9" style="padding-left: 0px; padding-right: 0px;">
                                        <div class="input-group">
                                            <input type="tel" name="telefoneD" id="telefoneD" required  value="<?php echo $numerocel; ?>" class="form-control phone" onkeyup="LimpaBordaVermelha(this.id);" />
                                            <div class="input-group-prepend"><div class="input-group-text"><i class="fas fa-phone"></i></div></div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group mt-5">
                            ...
                            <label class="checkbox-inline" >
                                <input type="radio" name="bankName" id="bradesco_debito" value="bradesco" checked><img src="checkout/img/bradesco_debito.jpg" border="0" align="absmiddle">
                            </label>
                            <label class="checkbox-inline" >
                                <input type="radio" name="bankName" id="itau_debito" value="itau"><img src="checkout/img/itau_debito.jpg" border="0" align="absmiddle">
                            </label>
                            <label class="checkbox-inline" >
                                <input type="radio" name="bankName" id="bb_debito" value="bancodobrasil"><img src="checkout/img/bb_debito.jpg" border="0" align="absmiddle" >
                            </label>
                            <label class="checkbox-inline" >
                                <input type="radio" name="bankName" id="banrisul_debito" value="banrisul"><img src="checkout/img/banrisul_debito.jpg" border="0" align="absmiddle">
                            </label>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <center>
                                    <br>
                                    <button id="enviarDebito" name="enviarDebito" class="btn btn-success btn-lg btn-block" type="button" data-loading-text="Aguarde..."><i class="fas fa-check-double"></i> PAGAR</button>
                                    <p><small>Confirmar Pagamento</small></p>
                                    <div id="carregandoDebito" class="text-center mt-3" style="display:none;">
                                      <div class="spinner-border" role="status" aria-hidden="true"></div>
                                      Carregando...
                                    </div>
                                </center>
                    ...
                    <!-- Pix -->
                    <div class="tab-pane fade show d-none" id="tabPIX" role="tabpanel" aria-labelledby="tabPIX-tab" style="display:none;">
