...
<div style="float:left; margin: 15px 15px 0px 0px;" class="col-md-auto col-md-6 d-none">
<figure class="figure mb-0">
  <img src="tarologos_admin/fotoreal/patty.jpg" title="Tarologa Patricia" alt="Tarologa Patricia" class="rounded img-fluid"/>
...
<p>Que tal começarmos? <a href="tarologos">Faça sua consulta aqui! <i class="fas fa-rocket"></i></a></p>

<p><i class="fas fa-om"></i> Gratidão.</p>