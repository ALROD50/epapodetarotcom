    ...
    if($row_onlinex=="offline" OR $row_onlinex==""){
      ...
      <div class="d-xl-block d-lg-block d-none">
        <div id="usuariobox">
          ...
          <p><i class="fas fa-shopping-cart center"></i> <a href="carrinho-compras" class="link-padraoum" title="Meu Carrinho"> <span class="badge badge-pill corpadrao1 mt-0"><?php echo $rowQuantidade; ?></span> Meu Carrinho</a></p>
        </div>
      </div>
      
      <!-- somente cel -->
      <div class="d-xl-none d-lg-none pt-2" style="font-size:17px;">
          <p class="mb-2"><i class="fas fa-home"></i> <a href="fazer-login" class="link-padraoum" title="Minha Conta">Entrar / Login</a> <i class="fas fa-shopping-cart"></i> <a href="carrinho-compras" class="link-padraoum" title="Meu Carrinho"> <span class="badge badge-pill corpadrao1 mt-0"><?php echo $rowQuantidade; ?></span> Carrinho</a></p>
      </div>
      <?php
    } else {
      ?>
      <div id="usuarioboxlogado">
        ...
        if ($usuario_nivel == 'CLIENTE') {
          ...
          <div class="d-xl-none d-lg-none pt-2">
            ...
            echo '<p class="mb-2">Saldo: <span style="color:#61f235;"><i class="fas fa-dollar-sign"></i> '.$valor.' Minutos</span> <a href="/minha-conta" style="color:#fff;"><i class="fas fa-user-circle"></i> Olá '.$usuario_nome.'</a>  <a href="/carrinho-compras" style="color:#fff;"><i class="fas fa-shopping-cart ml-1"></i> <span class="badge badge-pill badge-warning">'.$rowQuantidade.'</span> </a></p>';
            ?>
          </div>
          <?php
          ...
          <div class="pt-2" style="font-size:17px;">
            <?php 
            echo '<p class="mb-2" style="color:#fff;"><div id="onlineVerificaion" class="" style="display: contents;"><i class="fas fa-plug"></i></div> Olá, <a href="login/logout.php" style="color:#007bff;">Sair</a> | <i class="fas fa-cogs"></i> <a href="/minha-conta" style="color:#007bff;">ADMINISTRAÇÃO</a>';
            ?>
          </div>
          <?php
        }
