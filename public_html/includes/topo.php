...
<div id="header" class="row">
      ...
      <div id="usuarioboxlogado">
        ...
        if ($usuario_nivel == 'CLIENTE') {
          ...
          <div class="d-xl-none d-lg-none pt-3 pr-2">
            ...
            echo '<p class="" style="margin-bottom:-0.5rem">Saldo: <span><i class="fas fa-dollar-sign"></i> '.$valor.' Minutos</span> <a href="/minha-conta"><i class="fas fa-user-circle"></i> Olá '.$usuario_nome.'</a>  <a href="/carrinho-compras"><i class="fas fa-shopping-cart ml-1"></i> <span class="badge badge-pill  corpadrao1">'.$rowQuantidade.'</span> </a></p>';
            ?>
          </div>
          <?php
  ...
  <div class="row col-md-12 justify-content-center">
    <div id="" class="d-xl-block d-lg-block d-none mb-3">
