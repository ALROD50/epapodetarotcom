<?php 
// Selecionando a última conversa do tarologo.
$executa=$pdo->query("SELECT * FROM chat WHERE id_tarologo='$usuario_id' ORDER BY id DESC LIMIT 1 ");
...
if ($row > 0){
  ...
  if ($row23 == 0 AND $id_cliente != "" ){
    ...
    $pdo->query("INSERT INTO atendimento (
       ...
       '$tempo_restante',
       'Tarologo',
       'verifica_ult_consulta Tarologo.php'
    )");
